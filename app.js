...
function pg2func(op){
    ...
    btn1.style = "position: absolute;top: 222px;left: 28px;height: 75px;background: transparent;width: 277px;border-radius: 15%;border: 1px solid transparent;";
    ...
    btn2.style = "position: absolute;top: 318px;left: 28px;height: 75px;background: transparent;width: 277px;border-radius: 15%;border: 1px solid transparent;";
